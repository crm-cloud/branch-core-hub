// QA-only — render workout/diet PDFs.
...
import { buildPlanPdf } from '@/utils/pdfBlob';

const brand = {
  companyName: 'Incline Fitness', legalName: 'The Incline Life by Incline',
  website: 'theincline.in', supportEmail: 'support@theincline.in',
  branch: { name: 'Incline HSR', address: 'HSR Layout, Bengaluru', phone: '+91 98765 43210', email: 'hsr@theincline.in' },
};
