...
const HeroDumbbell = ({ scrollProgress, isMobile }: HeroDumbbellProps) => {
  ...
  return (
    <group ref={groupRef}>
      ...
      <Text position={[0, 0.12, 0]} fontSize={0.045} color="#3b82f6" anchorX="center" anchorY="middle">
        RISE · REFLECT · REPEAT
      </Text>
      <group ref={plate1Ref} position={[-0.6, 0, 0]}>
        ...
        <Text position={[0.05, 0, 0]} fontSize={0.12} color="#3b82f6" anchorX="center" anchorY="middle" rotation={[0, 0, Math.PI / 2]}>
          INCLINE
        </Text>
      </group>
      ...
      <group ref={plate4Ref} position={[0.6, 0, 0]}>
        <mesh geometry={largePlateGeometry} material={obsidianMaterial} rotation={[0, 0, Math.PI / 2]} />
        <mesh geometry={largePlateGeometry} material={glowMaterial} rotation={[0, 0, Math.PI / 2]} scale={[1.02, 0.3, 1.02]} />
        <Text position={[-0.05, 0, 0]} fontSize={0.12} color="#3b82f6" anchorX="center" anchorY="middle" rotation={[0, Math.PI, Math.PI / 2]}>
          INCLINE
        </Text>
      </group>
